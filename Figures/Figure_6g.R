...
## GSEA of on-treatment vs. pre-treatment samples in patients with long PFS (stromal compartment)
...
Bubble <- ggplot(fgseaRes_Tidy_1, aes(reorder(pathway, NES), NES, size=covered, color=padj))+
  ...
  labs(x="Significant Hallmark Pathways", y="Normalized Enrichment Score",
       title="Significant Hallmark pathways NES from GSEA between on and pre treatment in TME with Long PFS") + 
