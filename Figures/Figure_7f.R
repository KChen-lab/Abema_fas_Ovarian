...
## Heatmap showing expressions of key genes in tumor segments
set.seed(2023)
...
mat.z = read.csv("path-to-folder/Figure_7f.csv")
meta_data = read.csv("path-to-folder/Figure_7f_metadata.csv")
...
colours <- list(
  Patients = c("8"="#fbb463","13"="#8ed1c6","11"= "purple"),
...
split <- factor(ann$PFS, levels=c("Short","Long"))
