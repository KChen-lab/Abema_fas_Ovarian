...
## GSEA of short vs. long PFS patient samples at pre-treatment timepoint (tumor compartment)
...
Bubble <- ggplot(fgseaRes_Tidy_1, aes(reorder(pathway, NES), NES, size=covered, color=padj))+ #
  ...
  labs(x="Significant Hallmark Pathways", y="Normalized Enrichment Score",
       title="Significant Hallmark pathways NES from GSEA in TUMOR pre treatment between short and long PFS") + 
